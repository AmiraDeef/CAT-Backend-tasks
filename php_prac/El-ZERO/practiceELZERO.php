...
// echo '</pre>';
// echo '<pre>';
// print_r(array_reverse($friends,true)) ;//true for same index
// echo '</pre>';
// echo '<pre>';
// print_r(array_flip($friends)); //sawp key and value
// echo '</pre>';
// echo count($friends, 1); //1-->count elements of multidimensional array || 0--> defult mode doent count insde multidimensional array
// echo "<br>";
// if (in_array("Amira", $friends, true)) { //true for type
//     echo "found";
// }
// echo "<br>";
// if (array_key_exists("s", $friends,)) { //true for type
//     echo "found";
// }
// echo "<br>";
// print_r(array_keys($friends)); //true for type
// echo "<br>";
// print_r(array_values($friends)); //true for type
// echo '<pre>';
// print_r(array_pad($friends, 10, "S")); //complete array as U want after
// echo '</pre>';
// echo '<pre>';
// print_r(array_pad($friends, -10, "S")); //complete array as num and thigs u want before
// echo '</pre>';
// echo array_product($cou);
// echo "<br>";
// echo array_sum($cou);
// echo "<br>";
// echo current($cou);
...
// echo "<br>";
// echo '<pre>';
// print_r(array_merge($friends, $cou)); //swap values have same kays and merge them in one array
// echo '</pre>';
// echo '<pre>';
// print_r(array_replace($friends, $cou));
// echo '</pre>';
// echo array_rand($cou) . "<br>";
// shuffle($friends);
// echo '<pre>';
// print_r($friends);
// echo '</pre>';
// array_shift($cou);
// print_r($cou); // frist ele in array and reset to inernal point
// array_pop($cou);
// print_r($cou); // last ele in array and reset to inernal point
// array_push($cou, "55", "667");
// print_r($cou); // insert elements in array after 
// $cou[] = 6; //do like push but for one ele
// array_unshift($cou, 88, 77);//isert frist
// print_r($cou);
// echo '<pre>'; //slice doesnt be affected
// print_r(array_slice($friends, 3, 2)); //cut array as u want
// echo '</pre>';
// echo '<pre>';
// print_r(array_slice($friends, 1, -2)); //negation is ths stop point
// echo '</pre>';
// echo '<pre>';
// print_r(array_slice($friends, 1, -2, true)); //true keep the key value and not reset
// echo '</pre>';
// echo '<pre>';
// print_r(array_splice($friends, 1, 2)); //cut array as u want and remove them forever
// echo '</pre>';
// echo '<pre>';
// print_r(array_slice($friends, 1, -2)); //negation is num of remove after index
// echo '</pre>';
//
////sorting function array
//sort($friends);
//echo '<pre>';
//print_r($friends); //sort ascending by default
//echo '</pre>';
//rsort($friends);
//echo '<pre>';
//print_r($friends); //sort descending
//echo '</pre>';
//asort($friends);
//echo '<pre>';
//print_r($friends); //sorting ascending for values a
//echo '</pre>';
//arsort($friends);
//echo '<pre>';
//print_r($friends); //sorting descending for values a
//echo '</pre>';
//ksort($friends);
//echo '<pre>';
//print_r($friends); //sorting ascending for keys k
//echo '</pre>';
//krsort($friends);
//echo '<pre>';
//print_r($friends); //sorting descending for keys k
//echo '</pre>';
////natural sort
//natsort($cou);
//echo '<pre>';
//print_r($cou); //sorting for natural order
//echo '</pre>';
...
//echo "<br>";
//echo "<br>";
//print_r(array_map(fn($n1,$n2)=>$n1*$n2,$a,$b));
//echo '<pre>';
//print_r(array_filter($a,"check_num")); //check in values only
//echo '</pre>';
//echo '<pre>'; //IN NEXT USING FLAGS
//print_r(array_filter($a,"check_num",ARRAY_FILTER_USE_KEY)); //check in key only
//echo '</pre>';
//echo '<pre>';
//print_r(array_filter($a,"check_num",ARRAY_FILTER_USE_BOTH)); //check in both keys and values
//echo '</pre>';
...
//}
//$a=array(10,15,20);
//print_r(array_reduce($a,"myfunction",5)); //reduce array to a single value

//math function
//echo abs(-20)."<br>";//absolute value
//echo rand()."<br>";//random num and min =0
//echo rand(20,80)."<br>";
//echo mt_getrandmax()."<br>";// max
//echo intdiv(11,5)."<br>"; //return integer num
//echo gettype(11/5)."<br>";
//echo fmod(11,5)."<br>"; //return data type of num double
//echo gettype(11%5)."<br>";
